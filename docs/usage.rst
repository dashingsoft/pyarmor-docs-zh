...
对于客户来说就是黑盒子。当需要扩展认证方式的时候，那么需要了解 :ref:`运行时刻模块 pytransform`
提供的相关功能。
...
6. :ref:`使用插件来进一步提高安全性` ，运行辅助模块 :mod:`pytransform` 里面的
   函数 :func:`check_armored` 和修饰函数 :func:`assert_armored` 可以用来检查指定函
